...
-- drop table users, productinfo, carthistory, cart;
CREATE TABLE Users (
...
INSERT INTO
   Users (userID, userName, gender, email, isMember)
VALUES
   (1, 'Steph', 'F', 'steph@gmail.com', true);

INSERT INTO
   Users (userID, userName, gender, email, isMember)
VALUES
   (2, 'Andrew', 'M', 'andrew@gmail.com', false);

INSERT INTO
   Users (userID, userName, gender, email, isMember)
VALUES
   (3, 'Aarfa', 'F', 'aarfa@gmail.com', true);

INSERT INTO
   Users (userID, userName, gender, email, isMember)
VALUES
   (4, 'Bob', 'M', 'bob@gmail.com', true);
...
VALUES
(1, 'shirt', 'Tommy', '', '33403123', 1, 12.99, true);
...
VALUES
(2, 'pants', 'Tommy', '', '123425', 2, 42.99, false);
...
VALUES
(4, 'scarf', 'Karen Scott', '', '', 4, 12.99, true);
...
VALUES
(2, 1, 54, 'FREESHIP', '12/12/2020', 8.99);
...
VALUES
(4, 4, 1, 'LOVEISLOVE', '10/31/2011', 4.99);
...
VALUES
(2, 2, 2, '11/2/2020', '2/12/2021', true);
...
VALUES
(3, 3, 3, '10/2/2012', '12/12/2021', false);
...
VALUES
(4, 4, 4, '1/2/2012', '2/12/2021', false);
